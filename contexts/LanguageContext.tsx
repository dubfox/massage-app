...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'manager.addGroup': 'Add Group',
    'manager.addAllToQueue': 'Add All to Queue',
    ...
    // Payment Management
    'payment.collectPayment': 'Collect Payment',
    'payment.paymentManagement': 'Payment Management',
    'payment.outstandingPayments': 'Outstanding Payments',
    'payment.allGroups': 'All Groups',
    'payment.paid': 'Paid',
    ...
    'payment.servicesInGroup': 'Services in Group',
    'payment.paymentMethods': 'Payment Methods',
    'payment.paymentSummary': 'Payment Summary',
    'payment.groupsFullyPaid': 'Groups fully paid',
    'payment.groupsPartiallyPaid': 'Groups partially paid',
    'payment.groupsUnpaid': 'Groups unpaid',
    'payment.allPaymentsCollected': 'All payments collected!',
    'payment.noGroupPayments': 'No group payments yet.',
    'payment.manage': 'Manage',
    'payment.status': 'Status',
    'payment.servicesNotCompleted': 'Services Not Completed',
    'payment.completeServicesFirst': 'Complete all services first',
    'payment.completeServicesFirstDesc': 'Payment can only be collected after all services in this group are completed.',
    'payment.servicesInProgress': 'Services in progress',
    'payment.completeFirst': 'Complete First',
    'payment.paymentAvailableAfterCompletion': 'Payment available after service completion',
  ...
  th: {
    ...
    'manager.addGroup': 'เพิ่มกลุ่ม',
    'manager.addAllToQueue': 'เพิ่มทั้งหมดเข้าคิว',
    ...
    // Payment Management
    'payment.collectPayment': 'รับชำระเงิน',
    'payment.paymentManagement': 'จัดการการชำระเงิน',
    'payment.outstandingPayments': 'การชำระเงินที่ค้าง',
    'payment.allGroups': 'กลุ่มทั้งหมด',
    'payment.paid': 'ชำระแล้ว',
    'payment.partial': 'ชำระบางส่วน',
    'payment.unpaid': 'ยังไม่ชำระ',
    'payment.fullyPaid': 'ชำระเต็มจำนวน',
    'payment.partiallyPaid': 'ชำระบางส่วน',
    'payment.totalAmount': 'จำนวนเงินรวม',
    'payment.totalPaid': 'ชำระแล้ว',
    'payment.remaining': 'คงเหลือ',
    'payment.method': 'วิธีการ',
    'payment.amount': 'จำนวนเงิน',
    'payment.reference': 'หมายเลขอ้างอิง',
    'payment.verified': 'ยืนยันการชำระเงิน',
    'payment.savePayment': 'บันทึกการชำระเงิน',
    'payment.addPayment': 'เพิ่มการชำระเงิน',
    'payment.servicesInGroup': 'บริการในกลุ่ม',
    'payment.paymentMethods': 'วิธีการชำระเงิน',
    'payment.paymentSummary': 'สรุปการชำระเงิน',
    'payment.groupsFullyPaid': 'กลุ่มที่ชำระเต็มจำนวน',
    'payment.groupsPartiallyPaid': 'กลุ่มที่ชำระบางส่วน',
    'payment.groupsUnpaid': 'กลุ่มที่ยังไม่ชำระ',
    'payment.allPaymentsCollected': 'ชำระเงินครบทั้งหมดแล้ว!',
    'payment.noGroupPayments': 'ยังไม่มีการชำระเงินกลุ่ม',
    'payment.manage': 'จัดการ',
    'payment.status': 'สถานะ',
    'payment.servicesNotCompleted': 'บริการยังไม่เสร็จ',
    'payment.completeServicesFirst': 'เสร็จสิ้นบริการทั้งหมดก่อน',
    'payment.completeServicesFirstDesc': 'สามารถรับชำระเงินได้หลังจากบริการทั้งหมดในกลุ่มนี้เสร็จสิ้น',
    'payment.servicesInProgress': 'บริการกำลังดำเนินการ',
    'payment.completeFirst': 'เสร็จสิ้นก่อน',
    'payment.paymentAvailableAfterCompletion': 'ชำระเงินได้หลังจากบริการเสร็จสิ้น',
